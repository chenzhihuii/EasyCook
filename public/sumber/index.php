                        ...
                        <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="#menu">Resep</a></li>
                                    <li><a href="#footer">Pencarian</a></li>
                                </ul>
                            </div>
                            <!-- end nav-collapse -->
                        </nav>
                ...
                <div class="banner-static">
                    <div class="banner-text">
                        <div class="banner-cell">
                            <h1>Selamat Datang  <span class="typer" id="some-id" data-delay="200" data-delim=":" data-words="Sahabat:" data-colors="red"></span><span class="cursor" data-cursorDisplay="_" data-owner="some-id"></span></h1>
                            <h2>Bingung Mau Masak Apa? </h2>
                            <p>Temukan Berbagai Resep Lezat Setiap Hari</p>
                            <div class="book-btn">
                                <a href="#about" class="table-btn hvr-underline-from-center">Telusuri</a>
                            </div>
                            <a href="#about">
                                <div class="mouse"></div>
                            </a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <h3>Selamat datang di EasyCook!</h3>
                        <p>Kami adalah tim yang bersemangat dalam memberikan pengalaman kuliner yang menyenangkan dan praktis bagi Anda. Easy Cook adalah aplikasi yang dirancang khusus untuk memberikan rekomendasi resep-resep makanan yang lezat dan mudah untuk dipraktikkan di rumah.</p>
						
                        <p> Kami mengerti bahwa kegiatan memasak dapat menjadi kegiatan yang menyenangkan dan mendatangkan kebahagiaan. Oleh karena itu, Easy Cook hadir untuk memudahkan Anda dalam menemukan ide-ide makanan baru yang lezat dan menginspirasi setiap kali Anda memasak di dapur. </p>

                        <p> Terima kasih atas dukungan Anda dan selamat menikmati petualangan kuliner bersama Easy Cook!</p>
                    </div>
                </div>
                <!-- end col -->
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <h5 class="title-caption text-center"> Jelajahi dunia rasa bersama Easy Cook. Jadikan setiap kali makan sebagai perayaan rasa dan dapatkan kenikmatan yang sesungguhnya dalam dunia kuliner.</h5>
                    </div>
        ...
        <div class="footer-news pad-top-100 pad-bottom-70 parallax">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <h2 class="ft-title color-white text-center"> Pencarian </h2>
                            <p> Cari menu apapun yang kamu mau</p>
                        </div>
                        <form class="search-bar" action="cari.php" method="GET"> <!--action="connect.php"-->
                            <input type="text" id="search" name="search" placeholder="Menu paling enak">
                            <button class="orange-btn"> <i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
...
<div id="copyright" class="copyright-main">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h6 class="copy-title"> Copyright &copy; Kelompok 5 Teknologi Web Service </h6>
                    </div>
                </div>
                    <!-- end row -->
            </div>
